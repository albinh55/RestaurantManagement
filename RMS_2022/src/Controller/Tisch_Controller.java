...
public class Tisch_Controller implements Initializable {
    ...
    void addItemsToTable(ActionEvent event) {
       ...
       if(!(sp == null)) {
           ...
           String foodS = sp.getName() + "-" + converttoDouble(sp.getPreis()) + "-" + anzahl.getText()+ "-" + custNoTextF.getText();
       ...
       if(!(d == null)) {
           ...
           String drinkS = d.getName() + "-" + converttoDouble(d.getPreis()) + "-" + anzahl.getText() + "-" +custNoTextF.getText();
